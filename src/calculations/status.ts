...
function formatDelta(value: number, unitLabel: string): string {
  const digits = unitLabel.includes('kcal') || unitLabel.includes('mg') || unitLabel.includes('mL') || unitLabel.includes('cookie') || unitLabel.includes('serving') || unitLabel.includes('drink') || unitLabel.includes('bottle') || unitLabel.includes('tablet')
    ? 0
    : 1
